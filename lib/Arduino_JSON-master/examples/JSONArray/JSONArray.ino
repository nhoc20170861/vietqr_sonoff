...
void demoParse()
{
  ...
  // JSON.typeof_(jsonVar) can be used to get the type of the variable
  if (JSON.typeof_(myArray) == "undefined")
  {
  ...
  Serial.print("JSON.typeof_(myArray[0]) = ");
  Serial.println(JSON.typeof_(myArray[0]));
...
void demoCreation()
{
  ...
  for (int i = 0; i < myArray.length(); i++)
  {
    ...
    Serial.print(i);
    Serial.print("]) = ");
    Serial.println(JSON.typeof_(value));
