...
void booleanDemo()
{
  ...
  Serial.print("JSON.typeof_(myBoolean) = ");
  Serial.println(JSON.typeof_(myBoolean)); // prints: boolean
...
void intDemo()
{
  ...
  Serial.print("JSON.typeof_(myInt) = ");
  Serial.println(JSON.typeof_(myInt)); // prints: number
...
void doubleDemo()
{
  ...
  Serial.print("JSON.typeof_(myDouble) = ");
  Serial.println(JSON.typeof_(myDouble)); // prints: number
...
void stringDemo()
{
  ...
  Serial.print("JSON.typeof_(myString) = ");
  Serial.println(JSON.typeof_(myString)); // prints: string
...
void arrayDemo()
{
  ...
  Serial.print("JSON.typeof_(myArray) = ");
  Serial.println(JSON.typeof_(myArray)); // prints: array
...
void objectDemo()
{
  ...
  Serial.print("JSON.typeof_(myObject) = ");
  Serial.println(JSON.typeof_(myObject)); // prints: object
